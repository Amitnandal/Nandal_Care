              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav m-auto ">
                  <li className="nav-item mx-3"> 
                    ...
                    {/* <li className="nav-item mx-3">
                      <Link className="nav-link activtoxt-light " to="./wed.html"><h4>Wedding</h4></Link>
                    </li> */}
                    <li className="nav-item mx-3">
                        <Link className="nav-link activtoxt-light " to="./contact.html"><h4>Contact Us</h4></Link>
                      </li>
                      <li className="nav-item mx-3">
                          <Link className="nav-link activtoxt-light " to="./contact.html"><h4>login</h4></Link>
                        </li>
                </ul>
